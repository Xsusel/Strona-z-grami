...
Projekt wieloosobowej gry przeglądarkowej "Słowny Impostor" i "Rysunkowy Impostor".

## Wdrożenie za pomocą Docker Compose

Ten przewodnik opisuje, jak wdrożyć aplikację na serwerze VPS przy użyciu Dockera i Traefika.
...
Sklonuj to repozytorium na swój serwer:

```bash
git clone https://github.com/twoj-login/twoje-repo.git # Zmień na URL swojego repozytorium
cd twoje-repo # Zmień na nazwę katalogu
```
